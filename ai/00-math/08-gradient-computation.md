...
| Concept | Where Used |
|---------|------------|
| Reverse-mode AD | All deep learning training |
| Forward-mode AD | Jacobian computation, physics simulations |
| Gradient checking | Debugging custom ops / layers |
| Vanishing gradient solutions | Deep networks, transformers, RNNs |
| Gradient clipping | RNN training stability |
| Gradient checkpointing | Large-scale transformer training |
| Second-order gradients | MAML, natural gradient, Fisher information |
